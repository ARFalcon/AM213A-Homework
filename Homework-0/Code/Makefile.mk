...
EXECBIN    = piappx                     # Put all executables here
FSOURCE    = piappx.f90     # Put all source files (.f90) here
...
GFORTRAN   = gfortran -O3 -fdefault-real-8 -fdefault-double-8 # Put compilation command here
